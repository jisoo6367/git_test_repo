...
function showUploadResult(uploadResult) {
   ...
   if(!uploadResult || uploadResult.length == 0) {
      ...
      htmlStr +="<p style='font-size: 12pt;'>첨부파일이 없습니다</p>";
   ...
   //         + "    <a href='${contextPath}/fileDownloadAjax?fileName=" + fullFileName +"'>"
            ...
            + "        &nbsp;&nbsp;" + attachFile.fileName 
   //         + "    </a>"
            +  "  <button onclick='removeList()' type='button' class='btn btn-danger btn-xs' data-filename='" + fullFileName + "' data-filetype='F'>X</button>"
            + "</li>" ;
   ...
   //         + "    <a href=\"javascript:showImage('" + fullFileName + "')\">"
            ...
            + "        &nbsp;&nbsp;" + attachFile.fileName 
   //         + "    </a>"
            +  "  <button id='removeList' type='button' class='btn btn-danger btn-xs' data-filename='" + thumbnail + "' data-filetype='I'>X</button>"
            + "</li>" ;
         }
   ...
   fileUploadResult.children('p').remove();
...
$(".fileUploadResult ul").on("click","li button", function(){
   ...
   if($(".fileUploadResult ul").children('li').length == 0){
      $(".fileUploadResult ul").append("<p style='font-size: 12pt;'>첨부파일이 없습니다</p>");
   }
});
